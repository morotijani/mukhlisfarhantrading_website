	...
	<section class="inner-hero">
		<div class="wrap">
			<div>
				...
				<p class="lead">Hand tools, irrigation equipment and machinery for farms across the Ashanti Region —
					stocked to match the planting calendar, not to sit on a shelf.</p>
				<div class="hero-cta">
	...
	<section class="content">
		<div class="wrap">
			...
			<div class="content-body reveal">
				<p>A farm's equipment needs change with the season — clearing tools before land preparation, ploughs and
			...
			<div class="offer-grid reveal">
				<div class="offer-item">
					<div class="icon"><svg viewBox="0 0 34 34" fill="none" stroke="currentColor" stroke-width="1.6">
							<path d="M6 30 L14 12 M14 12 l6 6 M28 6 L14 20" />
				...
				<div class="offer-item">
					<div class="icon"><svg viewBox="0 0 34 34" fill="none" stroke="currentColor" stroke-width="1.6">
							<path d="M4 26 L12 26 L16 14 L22 14 L26 26 L30 26" />
