...
<title><?php echo isset($page_title) ? htmlspecialchars($page_title) : 'Mukhlis Farhan Trading Limited — Konongo, Ghana'; ?></title>
<meta name="description" content="<?php echo isset($page_description) ? htmlspecialchars($page_description) : 'Mukhlis Farhan Trading Limited: mining equipment, farming machinery, cattle farming and gold trading, based in Konongo, Ashanti Region, Ghana since 2018.'; ?>">
