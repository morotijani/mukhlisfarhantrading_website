...
<header class="site" id="siteHeader">
	<div class="wrap">
			...
			<div class="nav-item">
				...
				<div class="dropdown">
					<div class="dropdown-inner">
						...
						<a href="farm-machinery">Farm Machinery</a>
						<a href="cattle-farming">Cattle Farming</a>
						<a href="gold-trading">Gold Trading</a>
					</div>
				</div>
			</div>
			<a href="#why">Why Us</a>
		...
		<div class="cta">
			<a href="contact" class="btn btn-ghost" style="padding:10px 20px;font-size:13px;">Get in touch</a>
	...
	<div id="mobileMenu" style="display:none;background:var(--charcoal);border-top:1px solid var(--line);">
		<div class="wrap" style="display:flex;flex-direction:column;gap:0;padding-top:6px;padding-bottom:18px;">
			<a href="about" style="padding:12px 0;color:var(--cream);border-bottom:1px solid var(--line);">About</a>
			<a href="mining-equipment"
				style="padding:12px 0;color:var(--cream);border-bottom:1px solid var(--line);">Mining Equipment</a>
			<a href="farm-machinery" style="padding:12px 0;color:var(--cream);border-bottom:1px solid var(--line);">Farm
				Machinery</a>
			<a href="cattle-farming"
